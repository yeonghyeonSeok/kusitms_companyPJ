...
if __name__ == '__main__':
    ...
    #print('==========참여자별 파일 전송 횟수==========')
    participant_file = {}
    participant_file = count_send_file(df) #TODO: return값 받아서 저장
    #print('==========참여자별 질문 전송 횟수==========')
    participant_question = {}
    participant_question = count_send_question(df) #TODO: return값 받아서 저장
    #print('==========참여자별 사진 전송 횟수==========')
    participant_picture = {}
    participant_picture = count_send_picture(df) #TODO: return값 받아서 저장
    #print('==========참여자별 채팅 평균 길이==========')
    #mean_of_message_len(df) #TODO: 이 함수랑 밑에 함수는 위에 함수들이랑 다르게 df를 사용하는 방식이...? 조금 다른거같아서 제가 못건드렸어요ㅠㅠ
    #print('==========시간대별 채팅 빈도수==========')
    #time_chat_counts(df)
    # merge_json()
